...
local function source_matugen()
  ...
  local matugen_path = os.getenv("HOME") .. "/.config/nvim/lua/generated.lua"
...
local function auxiliary_function()
  ...
  dofile(os.getenv("HOME") .. "/.config/nvim/lua/plugins/neo-tree.lua") -- path of your lualine setup
  dofile(os.getenv("HOME") .. "/.config/nvim/lua/plugins/blink.lua") -- path of your lualine setup
